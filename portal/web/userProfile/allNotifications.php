        ...
        <div class="row">
          ...
          <div class="col-lg-3 g-mb-50 g-mb-0--lg">
            ...
            <div class="list-group list-group-border-0 g-mb-40">
                <!-- Overall -->
                <a href="userDashboard" class="list-group-item list-group-item-action justify-content-between">
                ...
                <!-- Comments -->
                <a href="allNotifications" class="list-group-item list-group-item-action justify-content-between active">
