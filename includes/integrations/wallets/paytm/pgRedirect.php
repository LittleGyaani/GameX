...
if(isset($_POST['ADDMONEY'])){
		...
		$insertUserActivity = $conn -> query("INSERT INTO `user_activity_history`(`user_id`, `user_last_action`, `user_activity_DTStamp`) VALUES ($CUST_ID,'wallet topup initiated','$CURRENT_DTSTAMP')");
