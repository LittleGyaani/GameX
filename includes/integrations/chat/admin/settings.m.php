...
function apikey() {
	global $ts, $body, $client, $apikey,$licensekey;
	$options = array(
				    ...
				    <div class="card-header">
			      	...
			      	<form id="devsetting" action="?module=settings&action=updatedevsetting&ts={$ts}" method="post">
			      		<div class="form-group row">
							<div class="col-md-12">
							<input class="form-control" readonly type="text" id="MC_PASSWORD" name="MC_PASSWORD" value="{$client}" >
							</div>
						</div>
		            </form>
EOD;
      			...
      			<div class="card-block" style="height:400px;">
		            ...
		            <div class="card-header">
			      	...
			      	<form id="devsetting" action="?module=settings&action=updatedevsetting&ts={$ts}" method="post">
			      		<div class="form-group row">
							<div class="col-md-12">
							<input class="form-control" readonly type="text" id="MC_PASSWORD" name="MC_PASSWORD" value="{$licensekey}" >
							</div>
						</div>
		            </form>
