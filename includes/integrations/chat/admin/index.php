...
if(!empty($enablecustomphp) && $enablecustomphp == 1 && file_exists(dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR."writable".DIRECTORY_SEPARATOR."custom".DIRECTORY_SEPARATOR.'custom.php')){
	include_once(dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR."writable".DIRECTORY_SEPARATOR."custom".DIRECTORY_SEPARATOR."custom.php");
}

session_name('CCADMIN');
session_start();

if(function_exists('hooks_sessionHandler')){
	hooks_sessionHandler();
}
			...
			<body class="navbar-fixed sidebar-nav fixed-nav">
				...
				<div class="container-fluid">
					...
					<div style="float:right;">
						<button type="button" class="btn btn-primary" onclick="location.href='?module=settings&action=apikey&{$ts}'";><b>API Keys</b></button>
					</div>
				</div>
				</header>
				<div class="sidebar">
