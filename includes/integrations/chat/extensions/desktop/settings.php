...
$base_url = BASE_URL;
/* To get login page logo */
if(!empty($client)){  // Check for client_id
	$upload_logo = '<div class="col-md-12" style="padding-top:7px;">Upload Logo URL<span>(Image size should be 200X60 and image format should be png)</span></div><div class="col-md-12"><input  name="LOGIN_LOGO_URL" class="form-control" id="logo" type="txt" style="margin-top:8px;" value="'.$login_logo_url .'" /></div>';
}else{
	$upload_logo = '<div class="col-md-12" style="padding-top:7px;">Upload Logo :</div><div class="col-md-12"><input  name="file" class="form-control" id="logo" type="file" style="margin-top:8px;" />
		</div>';
}
